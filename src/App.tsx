    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-50 font-sans selection:bg-indigo-500/30">
      ...
      <header className="relative overflow-hidden border-b border-white/10 bg-zinc-900/50 pt-24 pb-16">
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            A lightweight, ready-to-use Obsidian plugin that syncs your X
            (Twitter) bookmarks directly into your vault as beautifully
        ...
        <div className="lg:col-span-1 space-y-12" id="installation">
          ...
          <section className="bg-zinc-900/50 border border-emerald-500/20 rounded-2xl p-6">
            ...
            <ol className="list-decimal list-inside text-sm text-zinc-400 leading-relaxed space-y-2 mb-4">
              <li>
                Click the <strong>Twitter icon</strong> in your Obsidian ribbon.
              </li>
              <li>
                A side panel will open with X.com. Log in to your account.
              </li>
              <li>
                Navigate to your Bookmarks and <strong>scroll down</strong> to
                load them.
              </li>
              <li>
                Click the <strong>Extract Bookmarks</strong> button at the top
                of the panel.
              </li>
              <li>
                The plugin will scrape the loaded tweets and save them as
                Markdown files!
              </li>
            </ol>
          </section>
